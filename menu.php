        ...
        <div class="container">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="?action=cadastrar_carro">Cadastrar Carro</a></li>
                    <?php if ($logged_in): ?>
        ...
        <div class="container">
            ...
            <section class="features">
                ...
                <div class="feature-card">
                    ...
                    <p>Adicione novos veículos ao sistema.</p>
                    <a href="?action=cadastrar_carro" class="btn">Cadastrar</a>
                </div>
            </section>
        </div>
    </main>
